...
const THEME_SEEDS: ThemeSeed[] = [
  ...
  },
  {
    id: 'crimson-velvet',
    label: 'クリムゾンベルベット',
    description: '黒に近い深紅でまとめた重厚なダークテーマです。',
    category: 'color',
    isDark: true,
    effectClass: null,
    colors: {
  ...
  },
  {
    id: 'garnet-shadow',
    label: 'ガーネットシャドウ',
    description: 'ワインレッドを差し込んだ静かなダークテーマです。',
    category: 'color',
    isDark: true,
    effectClass: null,
    colors: {
  ...
  },
  {
    id: 'rose-nocturne',
    label: 'ローズノクターン',
    description: 'くすんだ濃いピンクで柔らかな陰影を作るテーマです。',
    category: 'color',
    isDark: true,
    effectClass: null,
    colors: {
  ...
  },
  {
    id: 'magenta-smoke',
    label: 'マゼンタスモーク',
    description: '煙がかった濃色に鮮やかなピンクを効かせたテーマです。',
    category: 'color',
    isDark: true,
    effectClass: null,
    colors: {
  ...
  },
  {
    id: 'ember-glow',
    label: 'エンバーグロウ',
    description: '黒に近い赤橙で火の余熱のような印象を出すテーマです。',
    category: 'color',
    isDark: true,
    effectClass: null,
    colors: {
  ...
  },
  {
    id: 'amber-depth',
    label: 'アンバーデプス',
    description: '深い琥珀色で温度感を残したダークテーマです。',
    category: 'color',
    isDark: true,
    effectClass: null,
    colors: {
  ...
  },
  {
    id: 'burnt-sienna',
    label: 'バーントシエナ',
    description: '焦げたオレンジと赤茶で奥行きを出したテーマです。',
    category: 'color',
    isDark: true,
    effectClass: null,
    colors: {
  ...
  },
  {
    id: 'copper-night',
    label: 'コッパーナイト',
    description: '銅の鈍い輝きを思わせる濃色オレンジ系テーマです。',
    category: 'color',
    isDark: true,
    effectClass: null,
    colors: {
  ...
  },
  {
    id: 'emerald-night',
    label: 'エメラルドナイト',
    description: '黒に近い緑へ鮮やかなエメラルドを差したテーマです。',
    category: 'color',
    isDark: true,
    effectClass: null,
    colors: {
  ...
  },
  {
    id: 'verdant-ink',
    label: 'ヴァーダントインク',
    description: '深い青緑で長時間見やすさを狙ったダークテーマです。',
    category: 'color',
    isDark: true,
    effectClass: null,
    colors: {
